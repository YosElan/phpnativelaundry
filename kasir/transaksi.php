                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="POST" action="koneksi.php">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="batas_waktu" class="form-control" id="batas_waktu" value="<?= $row['batas_waktu']; ?>" required>
                                                <?php echo "Tanggal Sebelumnya: " . $row['batas_waktu']; ?>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="biaya_tambahan" class="form-control" id="biaya_tambahan" value="<?= $row['biaya_tambahan']; ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="diskon" class="form-label">Diskon(%)</label>
                                                <input type="number" name="diskon" class="form-control" value="<?= $row['diskon']; ?>" id="diskon" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="pajak" class="form-label">Pajak</label>
                                                <input type="number" name="pajak" class="form-control" value="<?= $row['pajak']; ?>" id="pajak" required>
                                            </div>
                                            <div class="mb-3">
