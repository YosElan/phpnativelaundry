...
if (isset($_POST['edit_member'])) {
    ...
    $_SESSION["editMember"] = "Data berhasil Ditambahkan";
    header("location: member.php");
}
...
if (isset($_POST['simpan_transaksi'])) {
    ...
    $koneksi->query("INSERT INTO transaksi (id_transaksi, outlet_id, kode_invoice, member_id, tgl, batas_waktu, tgl_pembayaran, biaya_tambahan, diskon, pajak, status, status_bayar, user_id) 
                    VALUES ('$id_transaksi', '$outlet_id', '$kode_invoice', '$member_id', '$tgl', '$batas_waktu', '$tgl_pembayaran', $biaya_tambahan, $diskon, $pajak, '$status', '$status_bayar', '$user_id')");
...
if (isset($_POST['edit_transaksi'])) {
    ...
    $koneksi->query("UPDATE transaksi SET outlet_id='$outlet_id', kode_invoice='$kode_invoice', 
                    ...
                    tgl_pembayaran=$tgl_pembayaran, biaya_tambahan='$biaya_tambahan', diskon='$diskon', pajak='$pajak', status='$status', status_bayar='$status_bayar', user_id='$user_id' 
